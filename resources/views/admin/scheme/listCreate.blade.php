                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" action="{{ route('scheme-list-save', ['id'=>$uuid]) }}">
                                            @csrf
                                            <div class=" form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="month" class="form-control"
                                                                placeholder="Month" value="{{$max_month +1}}" required>
                                                            @else
                                                            <input type="text" name="month" class="form-control"
                                                                placeholder="Month Count" value="1" required>
                                                            @endif
                                                            @error('month')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="subs" class="form-control"
                                                                placeholder="Subs">
                                                            @error('subs')
                                                            <span class="help-block">{{ $message }}</span>
                                                            @enderror
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="cum" class="form-control"
                                                                placeholder="Cum" required>
                                                            @error('cum')
                                                            <span class="help-block">{{ $message }}</span>
                                                            @enderror
                                                        </div>
