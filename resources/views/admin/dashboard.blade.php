                            ...
                            <div class="card widget-box-three">
                                <div class="card-body">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <p class="text-muted mt-2 m-0"><span class="font-weight-medium">Last:</span>
                                            30.4k</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="card widget-box-three">
                                <div class="card-body">
                                    ...
                                    <div class="overflow-hidden">
                                        <p class="text-uppercase font-weight-medium text-truncate mb-2">User This Month
                                        </p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <h2 class="mb-0"><span data-plugin="counterup">652</span> <i
                                                class="mdi mdi-arrow-down text-danger font-24"></i></h2>
                                        <p class="text-muted mt-2 m-0"><span class="font-weight-medium">Last:</span> 956
                                        </p>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card-box">
                                ...
                                <div id="morris-bar-example" class="text-center morris-charts" style="height: 280px;">
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col-xl-4">
                            <div class="card-box">
                                ...
                                <div id="morris-line-example" class="text-center morris-charts" style="height: 280px;">
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-centered m-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <img src="{{asset('web/admin/assets/images/users/avatar-1.jpg')}}"
                                                        alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="{{asset('web/admin/assets/images/users/avatar-2.jpg')}}"
                                                        alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="{{asset('web/admin/assets/images/users/avatar-3.jpg')}}"
                                                        alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="{{asset('web/admin/assets/images/users/avatar-4.jpg')}}"
                                                        alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <img src="{{asset('web/admin/assets/images/users/avatar-5.jpg')}}"
                                                        alt="user" class="avatar-sm rounded-circle" />
                                                </th>
                                                <td>
